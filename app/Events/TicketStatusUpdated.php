    ...
    public function __construct(
        ...
        $this->ticketData = [
            ...
            'category' => $ticket->category ? [
                ...
                'infrastructure_type' => $ticket->category->infrastructure_type,
                'network_type' => $ticket->category->infrastructure_type,
            ] : null,
            ...
            'hold_reason_category' => $ticket->hold_reason_category,
            'hold_reason_note' => $ticket->hold_reason_note,
            'hold_started_at' => $ticket->hold_started_at?->toISOString(),
            'total_hold_duration_minutes' => $ticket->total_hold_duration_minutes,
